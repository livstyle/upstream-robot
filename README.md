...
<p align="center">
  <img src="public/logo.svg" alt="开源AI具象师 Logo" width="120" />
</p>
...
开源AI具象师是基于**辰龙操作系统 + RK3588**平台打造的具身智能开发平台。它不仅仅是实现机器人的平台，更是一切具身智能的核心基石——从医疗康复到智慧工厂，从教育实验到创意落地。

### 三大核心主题

#### 🔧 辰龙OS + RK3588 具身基座
辰龙操作系统是实现具身智能的系统与硬件基石，重点支持**教育**和**医疗**领域：
- **🎓 初等/高等教育** - 从STEAM启蒙到高校科研的完整学习路径
...
- 🎓 **教育全覆盖** - 从中小学STEAM到高校科研的完整支持
- 🏥 **医疗康复方案** - 帮助偏瘫患者的智能康复系统
- 🧠 **零代码开发** - 多模态描述，AI自动理解并实现
